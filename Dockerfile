...
LABEL version="4.3.1-BETA1"
LABEL description="EPAM Report portal. Rally Integration"

ENV APP_FILE service-rally-4.3.1-BETA1
ENV APP_DOWNLOAD_URL https://dl.bintray.com/epam/reportportal/com/epam/reportportal/service-rally/4.3.1-BETA1/$APP_FILE.jar
